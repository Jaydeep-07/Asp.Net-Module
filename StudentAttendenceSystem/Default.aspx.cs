...
namespace StudentAttendenceSystem
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        {
            String query = "insert into StudentAttendance1(rollno,studentname,dateofclass,attendancestatus,class) values(" + rollno + ",'" + studentname + "','" + dateofclass1 + "','" + status + "','" + sclass + "')";
